...
public class ShipItVillagerProfessions {
	public static final VillagerProfession MAILROOM = VillagerProfessionBuilder.create().id(new Identifier("shipit", "mailroom"))
		.workstation(ShipItPOIs.MAILROOM).workSound(SoundEvents.ENTITY_VILLAGER_WORK_LIBRARIAN).build();
	
	public static void init() {
		Registry.register(Registry.VILLAGER_PROFESSION, new Identifier("shipit", "mailroom"), MAILROOM);
		TradeOffers.PROFESSION_TO_LEVELED_TRADE.put(MAILROOM, new Int2ObjectOpenHashMap<TradeOffers.Factory[]>(ImmutableMap.of(
